...
module.exports = function(options, pCb) {
    var oauth2 = options.oauth2;
    var client = options.client;
    var sCode = options.sCode;
    ...
    async.waterfall([
        ...
        function(cb) {
            oauth2.model.accessToken.create(oauth2.model.code.getUserId(code), oauth2.model.code.getClientId(code), oauth2.model.code.getScope(code), ttl, function(err, data) {
                if (err)
