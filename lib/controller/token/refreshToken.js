    ...
    async.waterfall([
        ...
        function(cb) {
            ...
            if (accessToken) {
                ...
                oauth2.model.accessToken.create(oauth2.model.user.getId(user), oauth2.model.client.getId(client), oauth2.model.refreshToken.getScope(refreshToken), ttl, function(err, data) {
                    if (err)
